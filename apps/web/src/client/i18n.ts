...
const en = {
  ...
  overview: {
    ...
    inspector: {
      ...
      smartSearchPlaceholder: "Search title or paste TMDB/TVDB link",
      providerLinkHint: "Use tmdb:603, tvdb:movie:169, tvdb:series:121361, or paste a full provider URL.",
...
const zh = {
  ...
  overview: {
    ...
    inspector: {
      ...
      smartSearchPlaceholder: "搜索标题或粘贴 TMDB/TVDB 链接",
      providerLinkHint: "使用 tmdb:603、tvdb:movie:169、tvdb:series:121361，或粘贴完整提供方链接。",
      searchOptions: "搜索选项",
